...
exports.default = {
    title: 'UI/MyLabel',
    component: my_label_component_1.MyLabelComponent,
    argTypes: {
        size: {
            control: 'select'
        },
...
var Template = function (args) { return (0, jsx_runtime_1.jsx)(my_label_component_1.MyLabelComponent, __assign({}, args)); };
